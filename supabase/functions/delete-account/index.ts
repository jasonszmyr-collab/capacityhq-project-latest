...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    // Remove user-specific device notification tokens first.
    ...
    // Remove device membership records belonging to this user.
    ...
    if (membershipDeleteError) {
      console.error(
        "Failed to delete device memberships:",
    ...
    // Delete only the authenticated caller's Supabase Auth account.
